...
<div class="page-header">
    ...
    @elseif(Auth::user()->user_group_id == $bstiId)
        ...
        @include('dashboards.bstiDashboard')

    @elseif(Auth::user()->user_group_id == $bscicId)

        @include('dashboards.basicDashboard')

    @elseif(Auth::user()->user_group_id == $unicefId)

        @include('dashboards.unicefDashboard')

    @elseif(Auth::user()->user_group_id == $associationId)

        @include('dashboards.associationDashboard')

    @elseif(Auth::user()->user_group_id == $millerId)

        @include('dashboards.millerDashboard')
