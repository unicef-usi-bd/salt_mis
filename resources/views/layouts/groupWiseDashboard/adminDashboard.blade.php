        ...
        <div class="col-sm-7 infobox-container">
            <div class="infobox infobox-green infobox-medium infobox-dark">
                ...
                <div class="infobox-data">
                    ...
                    <div class="infobox-content">@php echo $totalMillerUnderAdmin; @endphp</div>
                </div>
            </div>
            ...
            <div class="infobox infobox-blue2 infobox-medium infobox-dark">
                ...
                <div class="infobox-data">
                    ...
                    <div class="infobox-content">@php echo $totalActiveMillerUnderAdmin; @endphp</div>
                </div>
            </div>
            ...
            <div class="infobox infobox-red infobox-medium infobox-dark">
                ...
                <div class="infobox-data">
                    ...
                    <div class="infobox-content">@php echo $totalDeactiveMillerUnderAdmin; @endphp</div>
                </div>
            </div>
