...
//                ->Where('sa_uglw_mlink.USER_ID', $userId)
    ...
    @if(Session::get('MILL_ID'))
        ...
        <div style="margin-top: 10px;margin-left: 10px;">
            {{--APK Here--}}
{{--            <a href="{{ asset("image/apk/unicef_salt_aa_v1.0.0_client.apk") }}" class="btn btn-success"><i class="fa fa-android" style="font-size: 18px;"></i> Download App <i class="fa fa-arrow-circle-o-down " style="font-size: 18px;"></i></a>--}}
            <a href="{{ asset("image/apk/unicef_salt_aa_v1.0.0_ati.apk") }}" class="btn btn-success"><i class="fa fa-android" style="font-size: 18px;"></i> Download App <i class="fa fa-arrow-circle-o-down " style="font-size: 18px;"></i></a>
        </div>
    @endif
