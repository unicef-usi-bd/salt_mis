<div class="col-md-12">
    <form action="{{ url('/user-groups/'.$editUserGroup->USERGRP_ID) }}" method="post" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input autocomplete="off" type="text" id="inputSuccess group_name" placeholder="{{ trans('module.example_group_name_here') }}" name="group_name" class="form-control col-xs-10 col-sm-5" value="{{ $editUserGroup->USERGRP_NAME }}"/>
            </div>
        </div>
       <!--  <div class="form-group">
