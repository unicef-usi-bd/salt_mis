        ...
        <div class="col-md-12" style="padding: 0px;">
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-7">
                    <span class="block input-icon input-icon-right">
                        <input autocomplete="off" type="text" id="inputSuccess link_name" placeholder="Example:Module Link Name Here" name="link_name" value="{{ $editData->LINK_NAME }}" class="width-100" />
                    </span>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-7">
                    <span class="block input-icon input-icon-right">
                        <input autocomplete="off" type="text" name="link_url" placeholder="Example:Module SL NO Here" value="{{ $editData->LINK_URI }}" id="inputSuccess link_url" class="width-100"  />
                    </span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-7">
                    <span class="block input-icon input-icon-right">
                        <input autocomplete="off" type="text" name="sl_no" value="{{ $editData->SL_NO }}" id="inputSuccess sl_no" class="width-100"  />
                    </span>
                </div>
            </div>
