<div id="bsti" class="tab-pane fade in active">
    <div class="row">
        <div class="col-md-12">
            <form action="" method="post" class="form-horizontal" role="form" >
                ...
                <div class="form-group statusAdminDiv">
                    ...
                    <div class="form-group divisionIdDiv">
                        ...
                        <div class="col-xs-8">
                            <span class="block input-icon input-icon-right">
                                <select id="bstiDivision" class="DIVISION_ID form-control  chosen-select width-65" name="DIVISION_ID" data-placeholder="Select or search data">
                    ...
                    <div class="form-group districtIdDiv">
                        ...
                        <div class="col-xs-8">
                        <span class="block input-icon input-icon-right">
                            <select id="bstiDistrict" class="form-control chosen-select district width-65" name="DISTRICT_ID" data-placeholder="Select or search data">
            ...
            <div class="clearfix">
                <div class="col-md-offset-3 col-md-9" style="margin-left: 40%!important;">
                    ...
                    <button type="submit" center-type="bsti" class="btn btn-primary btnReport">
