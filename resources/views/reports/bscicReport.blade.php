            ...
            <form action="" method="post" class="form-horizontal" role="form" >
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                                <span class="block input-icon input-icon-right ">
                                    ...
                                    <input type="text" id="reportrange"  name="reportrange" class="width-65 basicReportrange " />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <span class="block input-icon input-icon-right">
                                <select id="basicDivision" class="DIVISION_ID form-control chosen-select width-65" name="DIVISION_ID" data-placeholder="Select or search data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                        <span class="block input-icon input-icon-right">
                            <select id="basicDistrict" class=" form-control chosen-select district width-65" name="DISTRICT_ID" data-placeholder="Select or search data">
