        ...
        <div class="col-md-12">
            <form action="" method="post" class="form-horizontal" role="form" >
                ...
                <div class="form-group" style="margin-left: 75px">
                        ...
                        <div class="col-sm-5">
                            <span class="block input-icon input-icon-right">
                               <select  class="chosen-select chosen-container reportType4" name="PROCESS_TYPE_ID" data-placeholder="Select">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                            <span class="block input-icon input-icon-right">
                               <select class="status3" name="ACTIVE_FLG">
                                   <option value="">--Select--</option>
            ...
            <div class="clearfix">
                <div class="col-md-offset-3 col-md-9" style="margin-left: 40%!important;">
                    ...
                    <button type="submit" cost-center-type="basic" class="btn btn-primary btnReport">
