            ...
            <form action="" method="post" class="form-horizontal" role="form" >
                ...
                <div class="form-group adminReportrangeDiv">
                    ...
                    <div class="form-group renewDateDiv" style="margin-left:22px;width: 334px;">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="RECEIVE_DATE" id="RECEIVE_DATE" readonly value="{{date('m/d/Y')}}" class="width-100 date-picker renewDate" />
                        </div>
                    </div>
                    <div class="form-group failDateDiv" style="margin-left:22px;width: 334px;">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="RECEIVE_DATE" id="RECEIVE_DATE" readonly value="{{date('m/d/Y')}}" class="width-100 end-date failDate" />
                        </div>
                    </div>
                </div>
