        ...
        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <span class="block input-icon input-icon-right">
                               <select  class="chosen-select chosen-container reportTypeBasic" name="PROCESS_TYPE_ID" data-placeholder="Select">
            ...
            <div class="clearfix">
                <div class="col-md-offset-3 col-md-9" style="margin-left: 40%!important;">
                    ...
                    <button type="submit" center-type="basic" class="btn btn-primary">
