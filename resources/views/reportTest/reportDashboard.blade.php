            ...
            <div class="col-sm-12">
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        {{--admin Report--}}
                        @include('reportTest.adminReport')
                        {{--/-admin Report--}}
                        {{--unicef Report--}}
                        @include('reportTest.unicefReport')
                        {{--/-unicef Report--}}

                        {{--Bsti Report--}}
                        @include('reportTest.bstiReport')
                        {{--/-Bsti Report--}}

                        {{--Bscic Report--}}
                        @include('reportTest.bscicReport')
                        {{--/- Bscic Report--}}

                        {{--Association Report--}}
                        @include('reportTest.associationReport')
                        {{--/- Association Report--}}

                        {{--Millers Report--}}
                        @include('reportTest.millersReport')
                        {{--/- Millers Report--}}
    ...
    <script type="text/javascript">
        ...
        $(document).on('click','.btnReport',function(){
            ...
            if(center_type === 'admin'){
                ...
                var url = $('.reportTypeBasic').val();
                var centerId = $('.center').val();
                var activStatus = $('.status').val();
            }else if(center_type === 'bsti'){
                var url = $('.reportTypeBsti').val();
                var centerId = $('.center').val();
                var activStatus = $('.status').val();
...
//alert(status);
            $.ajax({
                type : "get",
                url  : url,
                data : {'centerId':centerId,'activStatus':activStatus,'startDate':startDate,'endDate':endDate,'highLowValue':highLowValue},
