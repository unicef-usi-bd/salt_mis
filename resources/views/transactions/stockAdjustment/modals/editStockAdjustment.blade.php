            ...
            <div class="col-md-12" style="margin-top: 15px; margin-left: 50px;">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="system_wc_stock" id="" placeholder=""  value="{{ $editStockAdjust->system_wc_stock }}" class="form-control col-xs-5 col-sm-5" readonly />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="system_iodize_stock" id="" placeholder=""  value="{{ $editStockAdjust->system_iodize_stock }}" class="form-control col-xs-5 col-sm-5" readonly />
                        </div>
                        <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="">KG</i>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="col-sm-6">
                            <input type="text" name="wc_stock" id="wc_stock" placeholder=""  value="{{ $editStockAdjust->wc_stock }}" class="form-control col-xs-5 col-sm-5"  />
                        </div>
                        <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="">KG</i>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-6">
                            <input type="text" name="iodize_stock" id="iodize_stock" placeholder=""  value="{{ $editStockAdjust->iodize_stock }}" class="form-control col-xs-5 col-sm-5" />
                        </div>
                        <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="">KG</i>
                    </div>
                </div>
