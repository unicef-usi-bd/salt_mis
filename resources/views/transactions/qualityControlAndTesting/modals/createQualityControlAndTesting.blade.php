    ...
    <form  action="{{ url('/quality-control-testing') }}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
        ...
        <div class="col-md-12" style="margin-top: 15px; margin-left: 100px;">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" name="SODIUM_CHLORIDE" id="SODIUM_CHLORIDE" placeholder="" onkeypress="return numbersOnly(this, event)"  value="" class="form-control col-xs-5 col-sm-5"  />
                    </div>
                    <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="fa fa-percent"></i>
                </div>
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" name="MOISTURIZER" id="MOISTURIZER" placeholder="" onkeypress="return numbersOnly(this, event)"  value="" class="form-control col-xs-5 col-sm-5" />
                    </div>
                    <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="fa fa-percent"></i>
                </div>
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" name="IODINE_CONTENT" id="IODINE_CONTENT" placeholder="" onkeypress="return numbersOnly(this, event)"  value="" class="form-control col-xs-5 col-sm-5" />
                    </div>
                    <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="fa fa-percent"></i>
                </div>
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" name="PH" id="PH" placeholder=""  value="" onkeypress="return numbersOnly(this, event)" class="form-control col-xs-5 col-sm-5"  />
                    </div>
                    <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="fa fa-percent"></i>
                </div>
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" name="water_insoluble_matter" id="water_insoluble_matter" placeholder=""  value="" onkeypress="return numbersOnly(this, event)" class="form-control col-xs-5 col-sm-5"  />
                    </div>
                    <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="fa fa-percent"></i>
                </div>
                <div class="form-group">
                    <div class="col-sm-6">
                        <input type="text" name="matter_soluble_sc" id="matter_soluble_sc" placeholder=""  value="" onkeypress="return numbersOnly(this, event)" class="form-control col-xs-5 col-sm-5"  />
                    </div>
                    <i style="margin-top: 10px; font-weight:bolder;font-size: larger;" class="fa fa-percent"></i>
                </div>
            </div>
