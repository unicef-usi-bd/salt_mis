<div class="col-md-12">
    ...
    <form action="{{ url('/email-templates/'.$editEmailTemplate->email_template_id) }}" method="post" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" id="inputSuccess email_subject" placeholder="{{ trans('emailTemplete.ex_email_subject') }}" name="email_subject" class="form-control col-xs-10 col-sm-5" value="{{$editEmailTemplate->email_subject}}"/>
            </div>
        </div>
