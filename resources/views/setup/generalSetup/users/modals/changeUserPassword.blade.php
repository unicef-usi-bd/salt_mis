<div class="col-md-12">
    ...
    {{--<form action="{{ url('/users-change-password/'.$editData->id) }}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">--}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="password" id="inputSuccess old_password" placeholder="Example:- Old password here" name="old_password" class="form-control col-xs-10 col-sm-5" value=""/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="password" id="inputSuccess password" placeholder="Example:- New password here" name="password" class="form-control col-xs-10 col-sm-5" value=""/>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="password" id="inputSuccess password_confirmation" placeholder="Example:- Confirm password here" name="password_confirmation" class="form-control col-xs-10 col-sm-5" value=""/>
