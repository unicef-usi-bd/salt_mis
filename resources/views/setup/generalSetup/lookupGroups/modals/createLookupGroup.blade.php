<div class="col-md-12">
    ...
    {{--<form class="form-horizontal frmContent" name="formData" method="POST">--}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input autocomplete="off" type="text" id="inputSuccess group_name" placeholder="{{ trans('lookupGroupIndex.exp_group_name') }}" name="LOOKUPMST_NAME" class="form-control col-xs-10 col-sm-5" value=""/>
            </div>
        </div>
        {{--<div class="form-group">--}}
