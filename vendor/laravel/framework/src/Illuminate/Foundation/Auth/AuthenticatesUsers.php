...
trait AuthenticatesUsers
{
    ...
    {
        $orgInfo =  Organization::getOrgInfoForSession();
        $userInfo = User::userDetails(Auth::user()->id);

        Session::put([
            'orgId' => $orgInfo->org_id,
            'orgName' => $orgInfo->org_name,
            'orgLogo' => $orgInfo->org_logo,
            'orgAddress' => $orgInfo->org_address,
            ...
            'USERGRP_ID' => $userInfo->USERGRP_ID
