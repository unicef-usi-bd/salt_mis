...
// Security Access Control
   ...
   // Route::get('bsti-test-result-range','BstiTestStandardController@editBstitestResutlRange');//jalal
    ...
    Route::get('certificate-by-mill-type/{id}','CertificateController@getCertificateByMillTypeId');
    ...
    Route::post('single-certificate-delete', 'CertificateController@singleCertificateDeleteByAjax'); //rubiyat
    Route::post('single-enterpreneur-delete', 'EntrepreneurController@singleEnterpreneurDeleteByAjax'); //rubiyat
    // modal edit mill information
    ...
    Route::get('purchase-salt-total-pdf/{itemTypeAssoc}', 'ReportAssociationController@getPurchaseSaltTotalPdf');//azharul
